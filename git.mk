...
.PHONY: git-status git-add git-commit git-push git-pull git-log git-diff git-stash git-clean git-reset
...
# Combined operations
git-save: git-add git-commit-auto ## Quick save: add all and commit with timestamp
	@echo "$(GREEN)✅ Quick save complete$(NC)"

git-save-ai: git-add git-commit-ai ## AI Brain save: add all and commit with AI message
...
git-sync: git-pull git-push ## Sync: pull then push
...
git-help: ## Show git help
	@echo "$(BLUE)Git Operations Help$(NC)"
	@echo "$(BLUE)==================$(NC)"
	@echo ""
